...
void bkgsig(std::string inputFile) {
  ...
  TH2F *h2_subjet1CSV = new TH2F("","",20,0,1,20,0,1);
  TH2F *h2_subjet2CSV = new TH2F("","",20,0,1,20,0,1);
  ...
  f->cd();
  h2_subjet1CSV->Add(h2_subjet2CSV);
  h2_subjet1CSV->Draw("colz");
